...
import { useRemoveWorkerFromProject } from '@/lib/project';
import { useParams } from 'next/navigation';
import { FormEvent, useRef } from 'react';
import { FormProvider } from 'react-hook-form';

const RemoveWorkerFromProjectForm = () => {
    const { id } = useParams();

    const projectId = String(id);

    const { formAction, form, state } = useRemoveWorkerFromProject({
        projectId,
    });
...
export default RemoveWorkerFromProjectForm;
